...
public class ColorMenu extends JFrame{
    ...
    JList colorList;
    // Color arrays
    private String[] colorNameArray = {"PURPLE", "LIGHT GRAY", "WHITE", "BLACK"};
    private Color[] colorClassArray = {new Color(175,175,199), Color.LIGHT_GRAY, Color.WHITE, Color.BLACK};
